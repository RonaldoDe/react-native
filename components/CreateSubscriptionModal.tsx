...
type Category = 'Design' | 'Developer Tools' | 'Entertainment' | 'IA Tools' | 'Productivity' | 'Other';

const CATEGORIES: Category[] = ['IA Tools', 'Developer Tools', 'Entertainment', 'Design' , 'Productivity', 'Other'];
...
const CreateSubscriptionModal = ({visible, onClose, onSubmit}: CreateSubscriptionModalProps) => {
    ...
    const handleSubmit = () => {
        ...
        const priceVale = parseFloat(price);
        const now = dayjs();
